...
require (
	...
	github.com/elastic/go-elasticsearch/v8 v8.0.0-20211214182512-ff567490444c // github.com/elastic/go-elasticsearch/v8@ff567490444c84fab79d49f24dc7824c9f6806a3
